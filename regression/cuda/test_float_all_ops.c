...
int kernel_float_all_ops () {
	...
	/* Enquque grid of tile groups, pass in grid and tile group dimensions*/
        ...
        /**********************************************************************/
	rc = hb_mc_application_init (&device, grid_dim, tg_dim, "kernel_float_all_ops", 10, argv);
	if (rc != HB_MC_SUCCESS) { 
