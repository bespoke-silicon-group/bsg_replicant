...
#
# LIBRARIES: Targets for building hardware/software libraries
LIBRARIES += $(TESTBENCH_PATH)/libfpga_mgmt.so
LIBRARIES += $(LIBRARIES_PATH)/libbsg_manycore_runtime.so
LIBRARIES += $(TESTBENCH_PATH)/vcs_simlibs

# CLEANS: Clean targets for Hardware/Software libraries
