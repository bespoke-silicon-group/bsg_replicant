#ifndef CUDA_ADD_KERNEL_FOUR_TILES_2_2_TWICE
#define CUDA_ADD_KERNEL_FOUR_TILES_2_2_TWICE
...
/*!
 * Runs the addition kernel on a 2 x 2 tile group at (2, 2) twice. 
 ...
 */
int cuda_add_kernel_four_tiles_2_2_twice (char *elf) {
	printf("Running the addition kernel on a 2 x 2 tile group at (2, 2) twice.\n\n");
	uint8_t fd; 
	hb_mc_init_host(&fd);
