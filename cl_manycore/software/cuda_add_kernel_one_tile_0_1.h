#ifndef CUDA_ADD_KERNEL_ONE_TILE_0_1
#define CUDA_ADD_KERNEL_ONE_TILE_0_1
...
/*!
 * Runs the addition kernel on 1 tile at (0, 1). 
 ...
 */
int cuda_add_kernel_one_tile_0_1 (char *elf) {
	printf("Running the addition kernel on a tile group of size 1 at (0, 1).\n\n");
	uint8_t fd; 
	hb_mc_init_host(&fd);
