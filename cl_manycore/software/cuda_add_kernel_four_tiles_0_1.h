#ifndef CUDA_ADD_KERNEL_FOUR_TILES_0_1
#define CUDA_ADD_KERNEL_FOUR_TILES_0_1
...
/*!
 * Runs the addition kernel on a 2 x 2 tile group at (0, 1). 
 ...
 */
int cuda_add_kernel_four_tiles_0_1 (char *elf) {
	printf("Running the addition kernel on a tile group of size 4.\n\n");
