...
int kernel_vec_add_parallel_multi_grid () {
	...
	******************************************************************************************************************/
	...
	uint32_t grid_dim_x1 = N / block_size_x1;
	uint32_t grid_dim_y1 = 1;
	uint32_t grid_dim_x2 = M / block_size_x2;
	uint32_t grid_dim_y2 = 2;
	...
	******************************************************************************************************************/
	hb_mc_grid_init (&device, grid_dim_x1, grid_dim_y1, tg_dim_x1, tg_dim_y1, "kernel_vec_add_parallel_multi_grid", 5, argv1);
	hb_mc_grid_init (&device, grid_dim_x2, grid_dim_y2, tg_dim_x2, tg_dim_y2, "kernel_vec_add_parallel_multi_grid", 5, argv2);
