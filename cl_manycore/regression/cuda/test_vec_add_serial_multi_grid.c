...
#define TEST_NAME "test_vec_add_serial_multi_grid"
...
int kernel_vec_add_serial_multi_grid () {
	...
	******************************************************************************************************************/
	...
	char* elf = BSG_STRINGIFY(BSG_MANYCORE_DIR) "/software/spmd/bsg_cuda_lite_runtime" "/vec_add_serial_multi_grid/main.riscv";
	...
	******************************************************************************************************************/
	rc = hb_mc_application_init (&device, grid_dim_1, tg_dim_1, "kernel_vec_add_serial_multi_grid", 5, argv1);
	if (rc != HB_MC_SUCCESS) { 
	...
	******************************************************************************************************************/
	rc = hb_mc_application_init (&device, grid_dim_2, tg_dim_2, "kernel_vec_add_serial_multi_grid", 5, argv2);
	if (rc != HB_MC_SUCCESS) { 
		bsg_pr_err("failed to initialize grid.\n");
		return rc;
	}
