...
set_property file_type "Verilog Header" [get_files $ENC_SRC_DIR/cl_fsb_defines.vh]
set_property is_global_include true [get_files $ENC_SRC_DIR/cl_fsb_defines.vh]
