...
const char *hb_mc_config_id_to_string(hb_mc_config_id_t id)
{
    static const char *strtab [] = {
        ...
        [HB_MC_CONFIG_VCACHE_IPOLY_HASHING] = "BLADERUNNER VCACHE IPOLY HASHING",
        [HB_MC_CONFIG_VCACHE_WORD_TRACKING] = "BLADERUNNER VCACHE WORD TRACKING",
        [HB_MC_CONFIG_VCACHE_NOTIFICATION_EN] = "BLADERUNNER VCACHE NOTIFICATION ENABLE",
        [HB_MC_CONFIG_ENABLE_DMA] = "BLADERUNNER ENABLE DMA",
        [HB_MC_CONFIG_ENABLE_DRAM_PODS_X] = "BLADERUNNER ENABLE DRAM NUMBER OF PODS X",
        [HB_MC_CONFIG_ENABLE_DRAM_PODS_Y] = "BLADERUNNER ENABLE DRAM NUMBER OF PODS Y",
