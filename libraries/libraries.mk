...
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_loader.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_eva.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_tile.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_bits.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_elf.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_memory_manager.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_cuda.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_printing.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_config.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_origin_eva_map.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_request_packet_id.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_responder.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_uart_responder.o
OBJECTS += $(LIBRARIES_PATH)/bsg_manycore_print_int_responder.o
...
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: INCLUDES  = -I$(SDK_DIR)/userspace/include
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: INCLUDES += -I$(LIBRARIES_PATH)
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: INCLUDES += -I$(HDK_DIR)/common/software/include 
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: INCLUDES += -I$(AWS_FPGA_REPO_DIR)/SDAccel/userspace/include 
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: CXXFLAGS  = -std=c++11 -fPIC -D_GNU_SOURCE $(INCLUDES)
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: LDFLAGS   = -lfpga_mgmt
$(LIBRARIES_PATH)/libbsg_manycore_runtime.so.1.0: $(OBJECTS)
	$(CXX) $(CXXFLAGS) -shared -Wl,-soname,libbsg_manycore_runtime.so.1 -o $@ $(OBJECTS) $(LDFLAGS)
