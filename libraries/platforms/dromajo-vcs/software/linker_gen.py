    ...
    SECTIONS {{
      ...
      {{
        *(*.manycore)
            ...
            _bp_dram_base=bp_dram_base, _sp=sp, _hb_dram_base=hb_dram_base
        )
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("bp_dram_base", help="The base address of DRAM for BlackParrot")
    parser.add_argument("sp", help="The top of the stack")
    parser.add_argument("hb_dram_base", help="The base address of DRAM for HammerBlade")
